  ...
  <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
      function drawVisualization() {
          ...
          var options = {
            title: 'County plotted against harvested acres and production over past 7 years',
            hAxis: {title: 'Harvested Acres in thousands'},
           ...
           var serverData = $.ajax({
          url: '/routes/farmerCropBubbleRouter.php',
          dataType: 'json',
