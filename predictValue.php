  ...
  <head>
    ...
    <script type="text/javascript">
      function drawVisualization() {
        ...
        var serverData = $.ajax({
          url: '/routes/predictValueRouter.php',
          dataType: 'json',
    ...
    <div class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
	  	...
	  	<h1 style="color:blue">Trend analysis of Revenue</h1>
  	<h3>Revenue is predicted for years 2013 and 2014 </h3>
  	<br>
  	<br>
